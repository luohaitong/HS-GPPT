...
class Discriminator(nn.Module):
    ...
    def forward(self, h1, h2, h3, h4, c):
        ...
        return logits
    # def forward(self, h2, h4, c):
    #     c_x = c.expand_as(h2).contiguous()
...
class Model(nn.Module):
    def __init__(self, in_dim, out_dim, K, dprate, dropout, is_bns, act_fn):
        ...
        # self.weight = nn.Linear(2*out_dim, out_dim)
    ...
    def get_embedding(self, edge_index, feat):
        ...
        #h= self.weight(torch.concat([h1,h2],dim=-1))
